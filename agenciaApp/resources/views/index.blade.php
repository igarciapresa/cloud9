        ...
        <div class="nonloop-block-13 owl-carousel">
                ...
                <div class="container">
                  <div class="row">
                    <div class="col-lg-6 mb-5">
                      <img src="{{url('assets/front/images/img_1.jpg')}}" alt="Image" class="img-md-fluid">
                    </div>
            ...
            <div class="item">
                <div class="container">
                  <div class="row">
                    <div class="col-lg-6 mb-5">
                      <img src="{{url('assets/front/images/img_2.jpg')}}" alt="Image" class="img-md-fluid">
                    </div>
                    <div class="overlap-left col-lg-6 bg-white p-md-5 align-self-center">
                      <p class="text-black lead">&ldquo;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Similique dolorem quisquam laudantium, incidunt id laborum, tempora aliquid labore minus. Nemo maxime, veniam! Fugiat odio nam eveniet ipsam atque, corrupti porro&rdquo;</p>
            ...
            <div class="item">
                <div class="container">
                  <div class="row">
                    <div class="col-lg-6 mb-5">
                      <img src="{{url('assets/front/images/img_4.jpg')}}" alt="Image" class="img-md-fluid">
                    </div>
                    <div class="overlap-left col-lg-6 bg-white p-md-5 align-self-center">
                      <p class="text-black lead">&ldquo;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Similique dolorem quisquam laudantium, incidunt id laborum, tempora aliquid labore minus. Nemo maxime, veniam! Fugiat odio nam eveniet ipsam atque, corrupti porro&rdquo;</p>
                      <p class="">&mdash; <em>James Martin</em>, <a href="#">Traveler</a></p>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <a href="#" class="unit-1 text-center">
              <img src="{{url('assets/front/images/01-greece.jpg')}}" alt="Image" class="img-fluid">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <a href="#" class="unit-1 text-center">
              <img src="{{url('assets/front/images/02-rome.jpg')}}" alt="Image" class="img-fluid">
              <div class="unit-1-text">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <a href="#" class="unit-1 text-center">
              <img src="{{url('assets/front/images/03-japan.jpg')}}" alt="Image" class="img-fluid">
              <div class="unit-1-text">
                <strong class="text-primary mb-2 d-block">$390</strong>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <a href="#" class="unit-1 text-center">
              <img src="{{url('assets/front/images/04-dubai.jpg')}}" alt="Image" class="img-fluid">
              <div class="unit-1-text">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <a href="#" class="unit-1 text-center">
              <img src="{{url('assets/front/images/05-london.jpg')}}" alt="Image" class="img-fluid">
              <div class="unit-1-text">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <a href="#" class="unit-1 text-center">
              <img src="{{url('assets/front/images/06-australia.jpg')}}" alt="Image" class="img-fluid">
              <div class="unit-1-text">
                <strong class="text-primary mb-2 d-block">$390</strong>
      ...
      <div class="container">
        ...
        <div class="row mb-3 align-items-stretch">
          <div class="col-md-6 col-lg-6 mb-4 mb-lg-4">
            <div class="h-entry">
              <img src="{{url('assets/front/images/hero_bg_1.jpg')}}" alt="Image" class="img-fluid">
          ...
          <div class="col-md-6 col-lg-6 mb-4 mb-lg-4">
            <div class="h-entry">
              <img src="{{url('assets/front/images/hero_bg_2.jpg')}}" alt="Image" class="img-fluid">
              <h2 class="font-size-regular"><a href="#">How to Plan Your Vacation</a></h2>
              <div class="meta mb-4">by Theresa Winston <span class="mx-2">&bullet;</span> Jan 18, 2019 at 2:00 pm <span class="mx-2">&bullet;</span> <a href="#">News</a></div>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus eligendi nobis ea maiores sapiente veritatis reprehenderit suscipit quaerat rerum voluptatibus a eius.</p>
            </div>
