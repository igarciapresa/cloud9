...
<html lang="en">
  ...
  <div class="site-wrap">
          ...
          <div class="col-10 col-md-8 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right text-lg-center" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mx-auto d-none d-lg-block">
                ...
                <li><a href="{{url('assets/front/discount.html')}}">Discount</a></li>
                <li><a href="{{url('assets/front/about.html')}}">About</a></li>
                <li><a href="{{url('assets/front/blog.html')}}">Blog</a></li>
    ...
    <div class="slide-one-item home-slider owl-carousel">
      ...
      <div class="site-blocks-cover overlay" style="background-image: url({{url('assets/front/images/hero_bg_1.jpg')}});" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
      ...
      <div class="site-blocks-cover overlay" style="background-image: url({{url('assets/front/images/hero_bg_2.jpg')}});" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            <a href="#" class="unit-1 text-center">
              <img src="{{url('assets/front/images/img_2.jpg')}}" alt="Image" class="img-fluid">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            <a href="#" class="unit-1 text-center">
              <img src="{{url('assets/front/images/img_1.jpg')}}" alt="Image" class="img-fluid">
              <div class="unit-1-text">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            <a href="#" class="unit-1 text-center">
              <img src="{{url('assets/front/images/img_3.jpg')}}" alt="Image" class="img-fluid">
              <div class="unit-1-text">
