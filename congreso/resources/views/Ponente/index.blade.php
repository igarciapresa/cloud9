                ...
                <div class="card-body row" style="display: flex;justify-content: space-around">
                  ...
                  @if(count($ponencias))
                    ...
                    <div>
                      ...
                      <a href="">Editar Ponencia</a>
                      <a href="" onclick="return confirm('¿Seguro que quieres borrar la ponencia {{$ponencia->titulo}}?')" style="color:red;">Borrar Ponencia</a>
                      <?php
                      $url = "{{$ponencia->url}}";
